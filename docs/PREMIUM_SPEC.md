...
| `all_diet_modes`           | nej (endast NNR Mode)                           | ja (alla 5: NNR, Weight Loss, Active, Off-/On-Season)    | UI (MacroModesCard i profilen: Använd-knapp + källreferens-modal intercept → UpgradeModal för låsta lägen; NNR alltid fri)                     |
