...
| `diet_phase_planning`       | nej                                             | ja                                                       | UI (`DietPhaseCard`: progressbar + `nextSuggested` + reverse-steget bakom gate, uppsäljningsruta annars; `PhasePickerDialog`: fälten Planerad längd och Upptrappning ersätts av uppsäljningsruta, och `handleStart` sparar då null för båda). GRATIS: välja fas, kalorimål, proteinmål, veckoräknare, byta fas. PREMIUM: fashistorik, planerad längd + progress, guidat nästa steg, reverse dietens veckoupptrappning. Kalorimålet gate:as ALDRIG — MyFitnessPal ger kalorimål gratis, ett lås där förlorar jämförelsen direkt. Fasen sätter aldrig makrofördelning; den pekar ut ett kostläge och hämtar kalori-/proteinmål därifrån  |
