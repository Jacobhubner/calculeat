...
export function EquationGate({ feature, children }: EquationGateProps) {
  ...
  return (
    <button
      ...
      className="flex w-full items-center justify-center gap-2 rounded-lg border border-dashed border-amber-300 bg-amber-50 px-4 py-3 text-sm font-medium text-amber-700 transition-colors hover:bg-amber-100"
    >
