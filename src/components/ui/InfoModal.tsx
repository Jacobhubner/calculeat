  ...
  return (
    <Portal>
      ...
      >
        ...
        >
          {/* Header */}
          <div className="sticky top-0 z-10 bg-white border-b border-neutral-200 p-6 rounded-t-2xl flex justify-between items-start gap-4">
            ...
            <button
              onClick={onClose}
              className="shrink-0 text-neutral-500 hover:text-neutral-700 transition-colors p-1 rounded-full hover:bg-neutral-100"
