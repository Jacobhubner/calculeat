...
// FFMI-formeln är publik (artikeln vad-ar-ffmi + FFMI-kalkylatorsidan)
// och visas därför alltid — publika ekvationer låses aldrig i appen
// (beslut 2026-07-18, se PREMIUM_SPEC).
    ...
    <div className="space-y-6 text-neutral-700 dark:text-neutral-200">
      ...
      <section className="bg-amber-50 border border-amber-200 rounded-lg p-4 dark:bg-amber-900/25 dark:border-amber-800">
        <h4 className="font-semibold text-amber-900 mb-2 dark:text-amber-300">
          {t('ffmi.section4Title')}
        </h4>
        <p className="text-sm text-amber-800 dark:text-amber-300">{t('ffmi.section4Text')}</p>
      </section>
    </div>
  )
}
