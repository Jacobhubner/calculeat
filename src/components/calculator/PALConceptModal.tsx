        ...
        <div className="p-6 space-y-6">
          ...
          <div>
            ...
            <div className="space-y-3">
              <p className="text-neutral-700 leading-relaxed">
                PAL-värdet multipliceras med din BMR för att få fram ditt totala dagliga energibehov
                (TDEE). Olika PAL-system använder olika metoder för att beräkna detta värde baserat
