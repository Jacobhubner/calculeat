          ...
          <div className="p-6 space-y-6">
            ...
            <div>
              ...
              <p className="text-neutral-700 leading-relaxed">
                ...
                upprätthålla alla livsnödvändiga funktioner som andning, cirkulation, organens
                arbete och cellernas grundläggande processer. Det är kroppens
                &ldquo;grundförbrukning&rdquo;.
              </p>
            </div>
              ...
              <ul className="space-y-2">
                <li className="flex gap-3">
                  ...
                  <span className="text-neutral-700 flex-1">
                    <strong>Mer muskelmassa</strong> – muskler kräver mer energi än fett även i
                    vila.
                  </span>
                </li>
                <li className="flex gap-3">
