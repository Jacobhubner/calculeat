...
const GOAL_COLORS: Record<Goal, string> = {
  cut: 'text-blue-700 dark:text-blue-300',
  maintenance: 'text-neutral-700 dark:text-neutral-200',
  bulk: 'text-green-700 dark:text-green-300',
}
...
const GOAL_RING_COLORS: Record<Goal, string> = {
  cut: 'border-blue-500 bg-blue-50 dark:bg-blue-900/25',
  maintenance: 'border-neutral-500 bg-neutral-50 dark:bg-neutral-900',
  bulk: 'border-green-500 bg-green-50 dark:bg-green-900/25',
}

const GOAL_RINGS: Record<Goal, string> = {
  cut: 'border-blue-500 bg-blue-500',
  maintenance: 'border-neutral-500 bg-neutral-500 dark:border-neutral-400 dark:bg-neutral-400',
  ...
  return (
    <div className="min-h-screen flex flex-col">
      ...
      <main className="flex-1">
            ...
            <div className="rounded-2xl border border-neutral-200 shadow-sm overflow-hidden dark:border-neutral-700">
              ...
              <div className="p-6 space-y-5">
                ...
                <div>
                  ...
                  <div className="flex items-center border border-neutral-200 rounded-lg overflow-hidden focus-within:ring-2 focus-within:ring-primary-300 focus-within:border-primary-400 max-w-[160px] dark:border-neutral-700">
                    <input
                      type="number"
                      inputMode="decimal"
                      value={weight}
                ...
                <div>
                  ...
                  <div className="space-y-2">
                    {goals.map(({ value, label, description }) => (
                      ...
                      >
                        <div
                          className={`mt-0.5 h-4 w-4 rounded-full border-2 flex-shrink-0 ${goal === value ? GOAL_RINGS[value] : 'border-neutral-300 bg-white dark:border-neutral-600 dark:bg-neutral-850'}`}
                        />
                        <div>
                ...
                <div>
                  ...
                  <div className="space-y-2">
                    {trainingStatuses.map(({ value, label, description }) => (
                      ...
                      >
                        <div
                          className={`mt-0.5 h-4 w-4 rounded-full border-2 flex-shrink-0 ${trainingStatus === value ? 'border-primary-500 bg-primary-500' : 'border-neutral-300 bg-white dark:border-neutral-600 dark:bg-neutral-850'}`}
                        />
                        <div>
                          <div
                            className={`text-sm font-medium ${trainingStatus === value ? 'text-primary-700 dark:text-primary-300' : 'text-neutral-800 dark:text-neutral-200'}`}
                          >
                            {label}
                          </div>
              ...
              {hasResult && result && (
                <div className="border-t border-neutral-100 bg-neutral-50 px-6 py-6 space-y-4 dark:bg-neutral-900">
                  ...
                  {/* Rationale */}
                  <div className="rounded-xl bg-white border border-neutral-200 p-4 dark:border-neutral-700 dark:bg-neutral-850">
                    <div className="text-xs font-medium text-neutral-500 uppercase tracking-wider mb-2 dark:text-neutral-400">
                  ...
                  <div className="rounded-xl bg-neutral-100 border border-neutral-200 p-4 dark:border-neutral-700 dark:bg-neutral-800">
                    <p className="text-xs font-medium text-neutral-700 mb-2 dark:text-neutral-200">
        ...
        <section className="bg-white py-14 border-b border-neutral-100 dark:bg-neutral-850">
          <div className="container mx-auto px-4 max-w-3xl">
            <div className="space-y-5 text-neutral-700 text-base leading-relaxed dark:text-neutral-200">
              ...
              {/* Reference table */}
              <div className="overflow-x-auto rounded-xl border border-neutral-200 mt-6 dark:border-neutral-700">
                  ...
                  <thead>
                    <tr className="bg-neutral-100 text-left dark:bg-neutral-800">
                      {(
                        ...
                        <th
                          key={i}
                          className="px-4 py-3 font-semibold text-neutral-700 border-b border-neutral-200 dark:border-neutral-700 dark:text-neutral-200"
                        >
                          {header}
                        </th>
                      ))}
                  ...
                  <tbody>
                    {(
                      ...
                      <tr key={ri} className={ri < 2 ? 'border-b border-neutral-100' : ''}>
                        <td className="px-4 py-3 font-medium text-neutral-700 bg-neutral-50 dark:bg-neutral-900 dark:text-neutral-200">
                          {row.label}
                        </td>
                        {row.cols.map((col, ci) => (
                          <td key={ci} className="px-4 py-3 text-neutral-600 dark:text-neutral-400">
                            {col}
                          </td>
                        ))}
                      </tr>
        ...
        {/* Sources */}
        <section className="bg-white py-10 border-b border-neutral-100 dark:bg-neutral-850">
          <div className="container mx-auto px-4 max-w-3xl">
            <h2 className="text-sm font-semibold text-neutral-500 uppercase tracking-wider mb-3 dark:text-neutral-400">
              Källor
            </h2>
