      ...
      <main className="flex-1">
        <div className="container mx-auto px-4 py-10 max-w-2xl">
          ...
          <p className="text-lg text-neutral-600 leading-relaxed mb-8 border-l-4 border-primary-400 pl-4 bg-primary-50 py-3 rounded-r-lg">
            ...
            vikten eller bygga muskler. Räkna ut ditt individuella proteinintervall baserat på vikt,
            mål och aktivitetsnivå.
          </p>
            ...
            <div className="p-6 space-y-5">
              ...
              <div>
                ...
                <div className="space-y-2">
                  {GOALS.map(
                    ({ value, label, minMultiplier, maxMultiplier, description, color, ring }) => (
                      <button
                        key={value}
          ...
          <section className="space-y-5 text-neutral-700 text-sm leading-relaxed mb-8">
            ...
            <ul className="space-y-3 pl-4 list-disc">
              ...
              <li>
                <strong>Under underhåll (maintenance):</strong> Du behöver protein för att reparera
                och bevara muskelvävnad, stötta immunsystem och enzymer. 1,4–1,8 g/kg räcker för de
                flesta aktiva.
              </li>
              <li>
                <strong>Under muskeluppbyggnad (bulk):</strong> Protein är råmaterialet för nya
                muskelfibrer. 1,6–2,2 g/kg är det vetenskapligt stödda optimala intervallet. Mer ger
                troligtvis inga ytterligare fördelar för muskeluppbyggnad.
              </li>
            </ul>
            ...
            <p>
              Kroppen kan effektivt utnyttja ca 20–40 g protein per måltid för muskelproteinsyntes.
              Att äta 150 g protein i en enda måltid är suboptimalt — sprid ut intaget jämnt över
              3–5 måltider. Det ger ett kontinuerligt flöde av aminosyror till muskelvävnaden.
            </p>
            <p>
              <strong>Praktisk tumregel:</strong> Sikta på 30–40 g protein per måltid, 3–4 gånger om
              dagen. Det är lättare att nå och ger bättre mättnadseffekt än få, stora portioner.
            </p>
