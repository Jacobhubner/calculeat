-- =========================================================
-- Ny plan-gräns: food_suggestions ("Vad ska jag äta?").
-- Intelligent livsmedelsrådgivare i dagens logg — premium
-- (precision & analys). Portionsberäknaren förblir gratis.
-- Endast UI-enforcement (ren klientberäkning).
